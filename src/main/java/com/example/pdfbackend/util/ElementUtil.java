...
import com.example.pdfbackend.dto.DocumentContent;
...
import static com.example.pdfbackend.util.FontUtil.formatFont;


/*
Initialized elements will be added to List and returned.
 */
@UtilityClass
@Slf4j
public class ElementUtil {
    ...
    public static void addWhitespaceElement(List<Element> elementLinkedList) {
        log.debug("Found whitespac eelement");
